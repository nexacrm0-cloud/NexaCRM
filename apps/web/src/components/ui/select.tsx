...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'border-border bg-card text-popover-foreground data-[state=open]:animate-fade-in relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border shadow-md',
